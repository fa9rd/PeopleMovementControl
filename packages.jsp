    ...
    <body>
        ...
        <div class="card card-1">
            ...
            <div class="row row-space">
                <div class="col-2">
                    <div class="p-t-20">
                        <a type="button" style="width:100%;font-size: 26px;" class="btn btn-primary" href="  <%= "DisplayAllPackages.jsp"%>" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Display All Packages&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
                ...
                <div class="col-2">
                    <div class="p-t-20">
                        <a type="button" style="width:100%;font-size: 26px;" class="btn btn-primary" href="  <%= "showAllsubscribers.jsp"%>" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Display All Subscriber&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
            ...
            <div class="row row-space">
                ...
                <div class="p-t-20">
                    <a type="button" style="width:100%;font-size: 26px;" class="btn btn-primary" href="  <%= "showAllActiveSubscriberPackage.jsp"%>" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Display All Active Subscriber&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
